        ...
        methods:{
            ...
            submitForm() {
                ...
                if(_this.keyWord == ''){
                    ...
                    axios.get(this.$store.state.globalhost+'product-service/seller/product/like/1/'+_this.pageSize+'/'+_this.keyWord).then(function (resp) {
                        _this.tableData = resp.data.data.content
                        _this.pageSize = resp.data.data.size
                        _this.total = resp.data.data.total
                    })
            ...
            categoryForm() {
                ...
                axios.get(this.$store.state.globalhost+'product-service/seller/product/findByCategory/1/'+_this.pageSize+'/'+_this.selectedCategory).then(function (resp) {
            ...
            page(currentPage){
                const _this = this
                if(_this.keyWord != ''){
                    axios.get(this.$store.state.globalhost+'product-service/seller/product/like/'+currentPage+'/'+_this.pageSize+"/"+_this.keyWord).then(function (resp) {
                        _this.tableData = resp.data.data.content
                        _this.pageSize = resp.data.data.size
                        _this.total = resp.data.data.total
                    })
                }else if(_this.selectedCategory != ''){
                    axios.get(this.$store.state.globalhost+'product-service/seller/product/findByCategory/'+currentPage+'/'+_this.pageSize+'/'+_this.selectedCategory).then(function (resp) {
                        _this.tableData = resp.data.data.content
                        _this.pageSize = resp.data.data.size
                        _this.total = resp.data.data.total
                    })
